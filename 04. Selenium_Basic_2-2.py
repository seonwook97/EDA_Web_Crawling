...
driver = webdriver.Chrome('C:/Users/고선욱/Documents/ds_study/driver/chromedriver.exe', options=options)
driver.get(url)
...
df.to_excel('C:/Users/고선욱/Documents/ds_study/source_code/sel_naver_finance.xlsx', encoding='utf-8')
print('Selenium quit!')